...
function buildCsp(nonce: string): string {
  return [
    ...
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://sb.mentora.su wss://sb.mentora.su https://accounts.google.com https://api.anthropic.com https://api.telegram.org https://*.posthog.com https://us.i.posthog.com https://us-assets.i.posthog.com https://eu.i.posthog.com https://eu-assets.i.posthog.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://stats.g.doubleclick.net https://mc.yandex.ru https://mc.webvisor.org",
