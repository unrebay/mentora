    ...
    <div ref={ref} className={`relative${forceDark ? " dark" : ""}`}>
      ...
      <button
        ...
        style={{
          ...
          // display:flex (not inline-flex) — inline-flex picks up the line-box
          // baseline, which is what made the avatar sit higher than the
          // Me/streak pills next to it. Block-level flex centres cleanly.
      ...
      {open && (
        <div
          ...
          style={{
            ...
            background: "linear-gradient(160deg, rgba(124,58,237,0.10), rgba(255,255,255,0.02) 60%, transparent), color-mix(in srgb, var(--bg-card) 66%, transparent)",
