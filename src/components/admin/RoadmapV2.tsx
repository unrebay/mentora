...
const SEED: RoadmapTaskV2[] = [
  ...
  { id: "ds_about", title: "🖥️ Десктоп — О нас (/dashboard/about)", bucket: "now", category: "design", state: "done", createdAt: new Date().toISOString() },
  ...
  { id: "mb_about", title: "📱 Мобайл (375/414/768) — О нас (/dashboard/about)", bucket: "soon", category: "design", state: "planned", createdAt: new Date().toISOString() },
  ...
  { id: "tc_about", title: "🔧 Тех-аудит — О нас (/dashboard/about)", bucket: "ideas", category: "tech", state: "planned", createdAt: new Date().toISOString() },
