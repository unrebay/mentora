...
const SUBJECT_CONFIG: Record<string, { emoji: string; hint: string; quickQuestions: string[] }> = {
  ...
  "discovery": { emoji: "🌐", hint: "Задай любой вопрос — наука, история, культура, природа. Или просто скажи «удиви меня»", quickQuestions: ["Удиви меня интересным фактом", "Самое необычное в природе", "Загадочные цивилизации древности"] },
};
