...
const STEPS: Step[] = [
  {
    ...
    title: "Ты в Mentora!",
    desc: "AI-ментор по 17 наукам — знает твой уровень и объясняет так, как тебе удобно. Пройдём быстрый тур?",
  ...
  },
  {
    ...
    icon: "star",
    tag: "Тарифы",
    title: "Free, Pro, Ultra",
    desc: "Free: 10 сообщений / 8 часов, навсегда. Pro (499 ₽/мес) — безлимит, все 17 наук, долгосрочная память. Ultra (799 ₽/мес) — плюс фото задач, презентации и PDF-конспекты.",
    tip: "Pro и Ultra можно отменить в один клик",
  },
  {
