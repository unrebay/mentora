...
export default function AnalyticsInvitePage() {
  ...
  if (error) return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "var(--bg)" }}>
      <div className="text-center">
        ...
        <h1 className="text-xl font-bold mb-2" style={{ color: "var(--text)" }}>Ссылка недоступна</h1>
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)", color: "var(--text)" }}>
      {/* Nav */}
      <div className="border-b backdrop-blur-md sticky top-0 z-50" style={{ background: "var(--bg-nav)", borderColor: "var(--border-light)" }}>
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-base font-bold" style={{ color: "var(--text)" }}>Mentora</span>
      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-5">
        ...
        <div className="rounded-2xl border px-6 py-5"
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold" style={{ color: "var(--text)" }}>{label}</h1>
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            <div key={c.label} className="rounded-2xl border p-5"
              ...
              <div className="text-xl font-bold" style={{ color: "var(--text)" }}>{c.value}</div>
        ...
        {active.length > 0 && (
          <div className="rounded-2xl border p-5"
            style={{ background: "var(--bg-card)", borderColor: "var(--border)" }}>
            <span className="text-sm font-semibold block mb-4" style={{ color: "var(--text)" }}>По предметам</span>
        ...
        {data.total_messages === 0 && (
          <div className="rounded-2xl border p-10 text-center"
            ...
            <p className="text-sm font-medium mb-1" style={{ color: "var(--text)" }}>Ученик ещё не начал заниматься</p>
