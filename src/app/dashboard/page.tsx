    ...
    <main className="min-h-screen text-[var(--text)]" style={{ background: "var(--bg)" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="mb-10">
          ...
          <div className="mb-4 flex items-center gap-3 rounded-2xl px-4 py-3.5 border"
            style={{
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs mt-0.5" style={{ color: "var(--text-muted)" }}>
                Mentora открывается для всех. Ты уже внутри — расскажи друзьям!
              </p>
            </div>
            <a href="/profile" className="shrink-0 text-xs font-semibold px-3 py-1.5 rounded-xl transition-all hover:opacity-80"
