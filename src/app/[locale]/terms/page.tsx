  ...
  return (
    <div className="min-h-screen" style={{ background: "#04060f", color: "#fff" }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        {/* Sections */}
        <div className="space-y-6 leading-relaxed text-sm" style={{ color: "rgba(255,255,255,0.55)" }}>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={i} className="flex gap-3">
                  <span className="w-1.5 h-1.5 rounded-full mt-2 shrink-0" style={{ background: "#4561E8" }} />
                  <span>{item.label ? <><strong style={{ color: "rgba(255,255,255,0.92)", fontWeight: 600 }}>{item.label}:</strong> {item.text}</> : item.text}</span>
                </li>
              ))}
            </ul>
          </section>
          ...
          <section className="rounded-2xl border p-6"
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="font-semibold text-base" style={{ color: "rgba(255,255,255,0.92)" }}>Реквизиты</h2>
            </div>
      ...
      <footer className="border-t py-8 mt-8" style={{ borderColor: "rgba(255,255,255,0.08)", background: "#04060f" }}>
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm" style={{ color: "rgba(255,255,255,0.35)" }}>
          ...
          <div className="flex gap-6">
            ...
            <Link href="/terms" className="font-semibold" style={{ color: "rgba(255,255,255,0.92)" }}>Условия</Link>
