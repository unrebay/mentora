...
const SUBJECT_META: Record<string, { title: string; description: string; keywords: string[] }> = {
  ...
  "psychology": {
    title: "Психология — AI-репетитор Mentora",
    description: "Учи психологию с AI-ментором: когнитивные процессы, личность, эмоции, социальная психология. Понятные объяснения для любого уровня.",
    keywords: ["психология онлайн", "репетитор психология", "когнитивная психология", "изучить психологию"],
  },
  "philosophy": {
    title: "Философия — AI-репетитор Mentora",
    description: "Изучай философию с AI: великие мыслители, этика, логика, метафизика. Понятные объяснения сложных идей в формате живого диалога.",
