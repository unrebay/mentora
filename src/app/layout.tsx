...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Живой диалог вместо учебника. 14 наук — история, математика, физика, химия и др. Для любого возраста. Бесплатно.",
    images: [
      {
        url: "/opengraph-image.png",
        width: 1200,
        height: 630,
        alt: "Mentora — новый вид образования — 14 наук с AI-ментором",
      },
    ],
  },
  twitter: {
